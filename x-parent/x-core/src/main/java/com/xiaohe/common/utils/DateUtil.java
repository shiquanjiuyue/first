...
public class DateUtil {
		...
		public static SimpleDateFormat time_format = new SimpleDateFormat("yyyyMMddHHmmss");
		...
		public static int getMonthFromDate(String dateString) {
			...
			// System.out.println("calendar.setTime::::" +
		...
		public static String getDateSringByAddDays(String date, int days, boolean isMonthStart, boolean isMonthEnd) {
			if (DateUtil.isMonthStart(date) && isMonthStart) {
				return date;
			}

			if (DateUtil.isMonthEnd(date) && isMonthEnd) {
				return date;
			}
			SimpleDateFormat format = new SimpleDateFormat(DATE_FORMAT);
			GregorianCalendar calendar = new GregorianCalendar();
		 ...
		 * @param date
		 * @param format
		 * @return <0： 小于某年某月 =0：等于某年某月 >0：大于某年某月
		 */
		...
		public static void main(String rgs[]) {
			/*
			 * System.out.println("去年年底:" +
			 * get1YearBeforeLastDay("2015-01-01")); System.out.println("前年年底:"
			 * + get2YearBeforeLastDay("2015-01-01"));
			 * System.out.println("去年同期:" + getLastYearPeriod("2017-12-31"));
			 * System.out.println("上月同期:" + getLastMonthPeriod("2017-03-29"));
			 * System.out.println("某年分月(截止到当月)" +
			 * getCurrYearMonths("2017-08-30", true));
			 * System.out.println("某年分月(12个月)" + getCurrYearMonths("2017-08-30",
			 * false)); System.out.println("某年上年12个月+当年截止到当月" +
			 * get2YearMonths("2017-08-30", true));
			 * System.out.println("某年上年12个月+当年12个月月" +
			 * get2YearMonths("2017-08-30", false));
			 ...
			 */
//			System.out.println(DateUtil.getXYearXMonthLastDay(2017, 2));
...
//			System.out.println(isMonthStart("2017-01-01"));
			System.out.println(getCron(getDateByAddMinutes(new Date(), 1)));
		}
}
